...
[Paul Graham](http://www.paulgraham.com/) is, among many things, a computer scientist, entrepreneur, and founder of [Y Combinator](https://www.ycombinator.com/). He's also an excellent essayist.
...
> #### 2.The second is to find --- or create --- the environment within which such a choice could be made. Seek out or propose greenfield projects, and involve others who are agitating to try new things. Startups get this for free; in the enterprise it's the concept of [intrapreneurship](https://motif.software/blog/intrapreneurship/).
